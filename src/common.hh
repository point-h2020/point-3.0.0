...
/** @brief A Click's HashTable of Click's Strings mapped to an ActiveNode.
 *
 */
typedef HashTable<String, ActiveNode *> ActiveNodeMap;
/** @brief An iterator to a Click's HashTable of Click's Strings mapped to an ActivePublication.
 */
typedef ActiveNodeMap::iterator ActiveNodMapIter;
/** @brief A Click's HashTable of Click's Strings mapped to unsigned char to Standardized NameSapces.
 */
typedef HashTable<String, unsigned char> KnownRootHashMap;
/** @brief An iterator Click's HashTable of Click's Strings mapped to unsigned char to Standardized NameSapces.
 */
typedef KnownRootHashMap::iterator KnownRootHashMapIter;
