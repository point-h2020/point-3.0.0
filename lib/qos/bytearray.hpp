...
class ByteArray{
  ...
  public:
    ...
    void append(uint8_t * ext_data, uint64_t ext_size);
    ...
    // VARIABLEs OPs
    void setBytes(const std::string &str, uint64_t offset_bytes, uint8_t offsetbits);
    std::string getStrBytes(uint8_t num, uint64_t offset_bytes, uint8_t offsetbits);
