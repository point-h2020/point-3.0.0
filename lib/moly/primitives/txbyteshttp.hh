...
#ifndef MOLY_PRIMITIVES_TXBYTESHTTP_HH_
#define MOLY_PRIMITIVES_TXBYTESHTTP_HH_

#include "../typedef.hh"

/*!
 * \brief Implementation of the RX_BYTES_HTTP_M primitive
 */
class TxBytesHttp {
public:
	/*!
	 ...
	 */
	TxBytesHttp(node_identifier_t nodeId, bytes_t txBytes);
	/*!
	 * \brief Constructor for MONAs
	 */
	TxBytesHttp(uint8_t *pointer, uint32_t size);
	/*!
	 * \brief Destructor
	 */
	~TxBytesHttp();
...
#endif /* MOLY_PRIMITIVES_TXBYTESHTTP_HH_ */
