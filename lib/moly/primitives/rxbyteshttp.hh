...
#ifndef MOLY_PRIMITIVES_RXBYTESHTTP_HH_
#define MOLY_PRIMITIVES_RXBYTESHTTP_HH_

#include "../typedef.hh"

/*!
 * \brief Implementation of the RX_BYES_HTTP_M primitive
 */
class RxBytesHttp {
public:
	/*!
	 ...
	 */
	RxBytesHttp(node_identifier_t nodeId, bytes_t rxBytes);
	/*!
	 * \brief Constructor for MONAs
	 */
	RxBytesHttp(uint8_t *pointer, uint32_t size);
	/*!
	 * \brief Destructor
	 */
	~RxBytesHttp();
...
#endif /* MOLY_PRIMITIVES_RXBYTESHTTP_HH_ */
