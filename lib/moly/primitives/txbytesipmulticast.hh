...
#ifndef MOLY_PRIMITIVES_TXBYTESIPMULTICAST_HH_
#define MOLY_PRIMITIVES_TXBYTESIPMULTICAST_HH_
 ...
 */
class TxBytesIpMulticast {
public:
	/*!
	 * \brief Constructor for processes
	 */
	TxBytesIpMulticast(node_identifier_t nodeId, ip_version_t ipVersion,
			bytes_t txBytes);
	/*!
	 * \brief Constructor for MONAs
	 */
	TxBytesIpMulticast(uint8_t *pointer, uint32_t size);
	/*!
	 * \brief Destructor
	 */
	~TxBytesIpMulticast();
...
#endif /* MOLY_PRIMITIVES_TXBYTESIPMULTICAST_HH_ */
