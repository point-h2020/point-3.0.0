...
namespace ns3 {
    ...
    void PubSubApplication::DoInitialize(void) {    //Object and subclasses DoStart has been renamed to DoInitialize in NS3.17 and above.
        NS_LOG_FUNCTION(this);
        Application::DoInitialize();                //Object and subclasses DoStart has been renamed to DoInitialize in NS3.17 and above.
    }
